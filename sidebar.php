...
<aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #d5d3d3">
    <div class="dropdown">
      <?php if($login_type == 1): ?>
        ...
        <img src='./upload/uploads/vineet logo.jpg' style='width: 14.5vw; height: 18vh; margin-left: -1.5vw; margin-top: -2vh; margin-bottom: -2vh; background: white;'>          
          <!-- <h3 class="text-center p-0 m-0"><b>BES Consultants</b></h3> -->
        </a>
        <?php else: ?>
          <a href="./index.php?page=user_left_view" class="brand-link">
          <img src='./upload/uploads/vineet logo.jpg' style='width: 14vw; height: 18vh; margin-left: -1.5vw; margin-top: -2vh; margin-bottom: -2vh; background: white;'>          
            <!-- <h3 class="text-center p-0 m-0"><b>USER</b></h3> -->
          </a>
          <?php endif; ?>
      </div>
    
    <div class="sidebar pb-4 mb-4" style="margin-top: 16vh;">
      <nav class="mt-2">
        ...
        <?php if ($login_type != 1): ?>
          <div style="color: #333; text-shadow: 1px 1px 2px black; margin-top: -1vh;">
          <hr style="color: #333;">
          <p style="display: flex; flex: 1; text-align: left; color: #333;">Folders:</p>
          <?php
    $folderPath = './upload/';
    ...
    <hr style="color: #333;">
    <p style="display: flex; flex: 1; text-align: left; color: #333; margin-left: 1vw;">Folders:</p>
    <?php
    $folderPath = './upload/';
    $folders = array_filter(glob($folderPath . '*'), 'is_dir');
    $selectedFolder = isset($_GET['folder']) ? $_GET['folder'] : '';
    ...
    foreach ($folders as $folder) {
        ...
        echo "<div style='display: flex; align-items: center; margin-bottom: 10px; {$highlightStyle}'>
                 <a href='?folder=$folderName' style='text-decoration: none; color: black;'>
                     <img src='./upload/uploads/folder-icon.png' style='width: 20px; height: 20px; margin-left: 1vw;'>
                 </a>
                 <a href='?folder=$folderName' style='text-decoration: none; color: #333; margin-left: 0.3vw;'>$folderName</a>
            </div>";
    }
